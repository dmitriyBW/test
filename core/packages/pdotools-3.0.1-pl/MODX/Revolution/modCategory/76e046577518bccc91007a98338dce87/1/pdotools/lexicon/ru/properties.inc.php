...
$_lang['pdotools_prop_customParents'] = 'Список id через запятую для кастомного построения хлебных крошек.';
...
$_lang['pdotools_prop_tplOdd'] = 'Имя чанка для каждого чётного ресурса (хоть "odd" значит "нечётный", работает для чётных ресурсов).';
...
$_lang['pdotools_prop_tplInner'] = 'Чанк-обёртка внутренних пунктов меню. Если пуст - будет использовать "tplOuter".';
$_lang['pdotools_prop_tplInnerHere'] = 'Чанк оформления активного пункта меню.';
$_lang['pdotools_prop_tplInnerRow'] = 'Чанк оформления одного пункта меню.';
