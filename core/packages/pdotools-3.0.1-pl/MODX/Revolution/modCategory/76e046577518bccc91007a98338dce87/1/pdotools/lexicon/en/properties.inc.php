...
$_lang['pdotools_prop_tplInnerRow'] = 'Name of the chunk containing the template for the one Resource if it is in a subfolder.';  // Really the current one??? See above!
