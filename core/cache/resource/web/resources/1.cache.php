...
<title>Главная</title>
<base href=\'https://test.b-w-group.ru/\'/>
<link rel="icon" href="/img/ET_msk_logo.svg" type=" image/svg+xml">
    <!-- Link Swiper\'s CSS -->
...
<body class="index-template">
            ...
            <div class="container">
                <div class="row">
                    <div class="col-md-3 logo">
                        <a href="https://test.b-w-group.ru/">
                        <img class="logo-img" src="/img/ET_msk_logo.svg" alt="triangle with equal sides" srcset="/img/ET_msk_logo.svg">
                        <h1>Евротех</h1>
                        </a>
                    </div>
                    <div class="col-md-6">
                    ...
                    <div class="col-md-3 phone-block">
                        <div class="phone">
                            ...
                            <a href="tel:+74950000000">+7 495 134-34-02</a>
                        </div>
                        <div class="phone">
        ...
        <div class="top-bar fix-true">
            <div class="top-bar-container container">
                <div class="inner relative">
                    ...
                    <div class="searchBox">
                        [[!SimpleSearchForm? &landing=`23` &tpl=`SearchFormNew`]]
                    </div>
                    <!-- <a href="#callback" class="btn fancyboxModal "><span class="">Заказать звонок</span></a>-->
	...
	&parents=`24`
	&includeContent=`1`
	&includeTVs=`image, img-bg, slider-link`
	&processTVs=`1`
]]
      </div>
      ...
      <div class="container relative">
          ...
          <div class="main-section__count"><b class="js-main-slider-count">1</b>
                    <span>из</span>
                    <span class="js-main-slider-total"></span>
        </div>
      </div>
    ...
    <div class="services-section">
        <div class="title-h2 text-center upper">Наше оборудование</div>
                ...
                <div class="row">
                   <div class="col-sm-6 col-lg-4">
                        <div class="element relative">
                            <a class="absolute" href="/catalog/texnicheskie-sredstva-oxranyi-perimetra/"></a>
                            <div class="img-wrapper">
                                <img src="/img/rupor.png" alt="Технические средства охраны периметра" width="60" height="60">
                                
                            </div>
                            <div class="element-content">
                                <h3>Технические средства охраны периметра</h3>
                            </div>
                        </div>
                    </div>
<div class="col-sm-6 col-lg-4">
                        <div class="element relative">
                            <a class="absolute" href="/catalog/oxrannoe-osveshhenie/"></a>
                            <div class="img-wrapper">
                                <img src="/img/lamp.png" alt="Охранное освещение" width="60" height="60">
                                
                            </div>
                            <div class="element-content">
                                <h3>Охранное освещение</h3>
                            </div>
                        </div>
                    </div>
<div class="col-sm-6 col-lg-4">
                        <div class="element relative">
                            <a class="absolute" href="/catalog/aksessuaryi.html"></a>
                            <div class="img-wrapper">
                                <img src="/img/key.png" alt="Аксессуары" width="60" height="60">
...
<div class="news-section">
    ...
    <div class="container">
        <div class="title-h2 text-center upper">Новости</div>
        <div class="push20 hidden-xs hidden-sm"></div>
        <div class="news">
            <!--<div class="title-h4"><a href="novosti/">Новости компании</a></div>-->
            <div class="row">
                [[!pdoResources?
	&tpl=`newsTpl`
	&limit=`2`
    ...
    <div class="text-center"> 
                        <a href="news/" class="btn btn-transparent">Смотреть все новости</a>
                    </div>
...
<div class="vantages-section">
    <div class="container">
        <div class="title-h2 text-center upper">Почему выбирают наше оборудование</div>
        <div class="push20 hidden-xs hidden-sm"></div>
        <div class="vantages">
            <div class="row">
                [[!pdoResources?
...
<div class="portfolio">
    <div class="container">
        <div class="text-center">
            <h2 class="upper">Наши заказчики</h2>
            <hr class="hr-min">
            <div class="text weight300 f14">
                Тескт предисловие для модуля с заказчиками
            </div>
             <div class="push20 hidden-xs hidden-sm"></div>
...
<!-- enf of portfolio -->
            ...
            <div class="footer-middle">
                <div class="container">
                    <div class="row">
                            ...
                            <div class="item item1">
                                <div class="footer-contacts">
                                    ...
                                    <div class="footer-contacts-item address-item">
                                        <svg aria-hidden="true" focusable="false" data-prefix="fal" data-icon="map-marker-alt" role="img" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 384 512" class="svg-inline--fa fa-map-marker-alt fa-w-12 fa-2x"><path fill="currentColor" d="M192 96c-52.935 0-96 43.065-96 96s43.065 96 96 96 96-43.065 96-96-43.065-96-96-96zm0 160c-35.29 0-64-28.71-64-64s28.71-64 64-64 64 28.71 64 64-28.71 64-64 64zm0-256C85.961 0 0 85.961 0 192c0 77.413 26.97 99.031 172.268 309.67 9.534 13.772 29.929 13.774 39.465 0C357.03 291.031 384 269.413 384 192 384 85.961 298.039 0 192 0zm0 473.931C52.705 272.488 32 256.494 32 192c0-42.738 16.643-82.917 46.863-113.137S149.262 32 192 32s82.917 16.643 113.137 46.863S352 149.262 352 192c0 64.49-20.692 80.47-160 281.931z" class=""></path></svg>
                                         105187, Москва, Окружной проезд, д.15, коп.2
                                    </div>
                                    ...
                                    <div class="footer-contacts-item phone-item">
                                        <svg aria-hidden="true" focusable="false" data-prefix="fal" data-icon="phone-alt" role="img" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 512 512" class="svg-inline--fa fa-phone-alt fa-w-16 fa-2x"><path fill="currentColor" d="M493.09 351.3L384.7 304.8a31.36 31.36 0 0 0-36.5 8.9l-44.1 53.9A350 350 0 0 1 144.5 208l53.9-44.1a31.35 31.35 0 0 0 8.9-36.49l-46.5-108.5A31.33 31.33 0 0 0 125 .81L24.2 24.11A31.05 31.05 0 0 0 0 54.51C0 307.8 205.3 512 457.49 512A31.23 31.23 0 0 0 488 487.7L511.19 387a31.21 31.21 0 0 0-18.1-35.7zM456.89 480C222.4 479.7 32.3 289.7 32.1 55.21l99.6-23 46 107.39-72.8 59.5C153.3 302.3 209.4 358.6 313 407.2l59.5-72.8 107.39 46z" class=""></path></svg>
                                        <a href="tel:+74951343402">+7 (495) 134-34-02</a>
                                    </div>
                                    ...
                                    <div class="footer-contacts-item phone-item">
                                        <svg aria-hidden="true" focusable="false" data-prefix="fal" data-icon="phone-alt" role="img" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 512 512" class="svg-inline--fa fa-phone-alt fa-w-16 fa-2x"><path fill="currentColor" d="M493.09 351.3L384.7 304.8a31.36 31.36 0 0 0-36.5 8.9l-44.1 53.9A350 350 0 0 1 144.5 208l53.9-44.1a31.35 31.35 0 0 0 8.9-36.49l-46.5-108.5A31.33 31.33 0 0 0 125 .81L24.2 24.11A31.05 31.05 0 0 0 0 54.51C0 307.8 205.3 512 457.49 512A31.23 31.23 0 0 0 488 487.7L511.19 387a31.21 31.21 0 0 0-18.1-35.7zM456.89 480C222.4 479.7 32.3 289.7 32.1 55.21l99.6-23 46 107.39-72.8 59.5C153.3 302.3 209.4 358.6 313 407.2l59.5-72.8 107.39 46z" class=""></path></svg>
                                        <a href="tel:+78005113411">8 800 511-34-11</a>
                                    </div>
                                    ...
                                    <div class="footer-contacts-item email-item">
                                        ...
                                        <a href="mailto:electro@sitename.com">info@sitename.com</a>
                                    </div>
                                    <div class="footer-contacts-item email-item">
                                        <object type="image/svg+xml" data="/img/youtube.svg">
                        ...
                        <div class="col-xs-12 col-md-3 text-right-md">
 ...
 <script>
        ...
        })(window,document,\'https://cdn-ru.bitrix24.ru/b22439962/crm/site_button/loader_2_thhxgg.js\');
</script>
    </footer>
...
<script src="/js/scripts.js"></script>
    ...
    <!-- Initialize Swiper -->
    <script>
    $(\'.js-main-slider-total\').html($(\'.swiper-slide\').length);
      var swiper = new Swiper(".mySwiper", {
        ...
        on: {
            slideChange: function () {
                $(".js-main-slider-count").html(swiper.realIndex + 1)
            },
        },
      });
    </script>
    ...
    <!-- action form -->
<!--<div class="top-form-wrapper" id="actionblock">
    <div class="container">
        <div class="top-form-box" id="topForm">
            <div class="top-form-box-inner">
                <div class="row">
                    <div class="col-sm-6">
                        <div class="title">Внимание АКЦИЯ!</div>
                        <div class="subtitle">Заполните заявку прямо сейчас и получите скидку 10% на электрику под ключ</div>
                    </div>
                    <div class="col-sm-6">
                        <div class="countdown-wrapper">
                            <div id="countdown" class="countdownHolder"><span class="countDays"><span class="position">					<span class="digit static" style="top: 0px; opacity: 1;">0</span>				</span>				<span class="position">					<span class="digit static" style="top: 0px; opacity: 1;">0</span>				</span></span><span class="countDiv countDiv0"></span><span class="countHours"><span class="position">					<span class="digit static" style="top: 0px; opacity: 1;">1</span>				</span>				<span class="position">					<span class="digit static" style="top: 0px; opacity: 1;">1</span>				</span></span><span class="countDiv countDiv1"></span><span class="countMinutes"><span class="position">					<span class="digit static" style="top: 0px; opacity: 1;">2</span>				</span>				<span class="position">					<span class="digit static" style="top: 0px; opacity: 1;">0</span>				</span></span><span class="countDiv countDiv2"></span><span class="countSeconds"><span class="position">					<span class="digit static" style="top: 0px; opacity: 1;">2</span>				</span>				<span class="position">					<span class="digit static" style="top: 0px; opacity: 1;">0</span>				</span></span></div>
                        </div>
                    </div>
                </div>
                <div class="rf">
                    <form method="post" class="ajax_form" id="actionform">
    <br>
    <div class="row">
        <div class="col-sm-6">
            <div class="agreement form-group">
                <input type="checkbox" name="agreement" id="agreement_action" class="required">
                <label for="agreement_action">
    ...
    <div class="row">
        <div class="col-sm-4">
            <div class="form-group">
                <input name="fio" value="" type="text" class="form-control required" placeholder="Имя *">
            </div>
        </div>
        
        <div class="col-sm-4">
            <div class="form-group">
                <input name="tel" value="" type="tel" class="form-control required tel" placeholder="Телефон *">
            </div>
        </div>
        <div class="col-sm-4">
            <div class="form-group">
                <input type="submit" name="actionbtn" class="btn block" value="Отправить">
            </div>
        </div>
    </div>
    <div class="push15"></div>

	<input type="hidden" name="af_action" value="0b889c50cf7745fc88b7ffc9d92da72e">
</form>
                </div>
            </div>
        </div>
...
<div class="col-sm-6 col-lg-4">
 ...
 <script>
    ...
    '[[$scripts]]' => '<script src="/js/jquery-3.2.1.min.js"></script>
<script src="https://cdnjs.cloudflare.com/ajax/libs/bootstrap/5.2.2/js/bootstrap.bundle.min.js" integrity="sha512-BOsvKbLb0dB1IVplOL9ptU1EYA+LuCKEluZWRUYG73hxqNBU85JBIBhPGwhQl7O633KtkjMv8lvxZcWP+N3V3w==" crossorigin="anonymous" referrerpolicy="no-referrer"></script>
<script src="/js/lightgallery-all.min.js"></script>
<script src="/js/modernizr.js"></script>
<script src="https://cdn.jsdelivr.net/npm/@fancyapps/ui@4.0/dist/fancybox.umd.js"></script>
<script src="/js/slick.min.js"></script>
<script src="/js/scripts.js"></script>',
    '[[%simplesearch.search? &namespace=`simplesearch` &topic=`default`]]' => 'Поиск',
    '[[If?
	&subject=``
	&operator=`NOTEMPTY`
	&then=`<img src="" class="img-fluid">`
	&else=``
]]' => '',
    '[[If?
	&subject=`img/slider/strateg-vt-636x636.png`
	&operator=`NOTEMPTY`
	&then=`<img src="img/slider/strateg-vt-636x636.png" class="img-fluid">`
	&else=``
]]' => '<img src="img/slider/strateg-vt-636x636.png" class="img-fluid">',
    '[[If?
	&subject=`img/slider/okra-s-636x636.png`
	&operator=`NOTEMPTY`
	&then=`<img src="img/slider/okra-s-636x636.png" class="img-fluid">`
	&else=``
]]' => '<img src="img/slider/okra-s-636x636.png" class="img-fluid">',
  ),
  'sourceCache' => 
  array (
 ...
 <script>
      ...
      array (
        ...
        array (
          ...
          'category' => 3,
          'cache_type' => 0,
          'snippet' => '<script src="/js/jquery-3.2.1.min.js"></script>
<script src="https://cdnjs.cloudflare.com/ajax/libs/bootstrap/5.2.2/js/bootstrap.bundle.min.js" integrity="sha512-BOsvKbLb0dB1IVplOL9ptU1EYA+LuCKEluZWRUYG73hxqNBU85JBIBhPGwhQl7O633KtkjMv8lvxZcWP+N3V3w==" crossorigin="anonymous" referrerpolicy="no-referrer"></script>
<script src="/js/lightgallery-all.min.js"></script>
<script src="/js/modernizr.js"></script>
<script src="https://cdn.jsdelivr.net/npm/@fancyapps/ui@4.0/dist/fancybox.umd.js"></script>
...
<script src="/js/scripts.js"></script>',
          ...
          'static' => false,
          'static_file' => '',
          'content' => '<script src="/js/jquery-3.2.1.min.js"></script>
<script src="https://cdnjs.cloudflare.com/ajax/libs/bootstrap/5.2.2/js/bootstrap.bundle.min.js" integrity="sha512-BOsvKbLb0dB1IVplOL9ptU1EYA+LuCKEluZWRUYG73hxqNBU85JBIBhPGwhQl7O633KtkjMv8lvxZcWP+N3V3w==" crossorigin="anonymous" referrerpolicy="no-referrer"></script>
<script src="/js/lightgallery-all.min.js"></script>
<script src="/js/modernizr.js"></script>
<script src="https://cdn.jsdelivr.net/npm/@fancyapps/ui@4.0/dist/fancybox.umd.js"></script>
    ...
    if (!empty($toPlaceholder)) {
      ...
      array (
        ...
        array (
          ...
          'category' => 7,
          'cache_type' => 0,
          'snippet' => 'use SimpleSearch\\SimpleSearch;
/**
...
return $search->output($output, $scriptProperties[\'toPlaceholder\']);',
          ...
          'static' => false,
          'static_file' => '',
          'content' => 'use SimpleSearch\\SimpleSearch;
/**
 * Show the search form
 *
 * @var modX $modx
