<?php  return array (
  'formit' => 'FormIt',
  'formit.desc' => 'Посмотреть все отправленные формы',
  'area_formit' => 'FormIt',
  'area_formit_recaptcha' => 'FormIt reCAPTCHA',
  'formit.form' => 'Форма',
  'formit.forms' => 'Формы',
  'formit.forms_desc' => 'Посмотреть все отправленные формы',
  ...
  'formit.form_decrypt' => 'Отменить шифрование форм(ы)',
  'formit.form_decrypt_confirm' => 'Вы уверены, что хотите отменить шифрование форм(ы)?',
  ...
  'formit.forms_clean_desc' => 'Европейский <a href="https://ec.europa.eu/info/law/law-topic/data-protection/eu-data-protection-rules_en" target="_blank">Общий регламент по защите данных (GDPR)</a> требует, чтобы личные данные, которые больше не используются, были удалены. Этот инструмент позволяет удалять сохраненные формы старше указанных ниже дней. Это действие не может быть отменено!',
  ...
  'formit.max_length' => 'Это поле не может быть длиннее, чем [[+length]] символ(а/ов).',
  ...
  'formit.storeAttachment_mediasource_error' => 'Источник медиа (Media Source) не найден! ID источника: ',
  ...
  'formit.migrate_running' => 'В настоящее время выполняется процесс переноса данных в фоновом режиме. Пожалуйста, держите эту страницу открытой в вашем браузере. <strong>НЕ ЗАКРЫВАЙТЕ ЭТУ СТРАНИЦУ!</strong>',
